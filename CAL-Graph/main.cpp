 ...
 *      Este sistema reliza a gest鉶 de uma Loja Electr髇ica de Electrodomesticos, com base no uso
 *      de grafos.
 */
...
//		cout << "2-Gestao de Encomendas" << endl;
//		cout << "3-Gestao de Zonas" << endl;
//		cout << "4-Gestao de Grafo" << endl;
...
//					string nome;
//					cout <<" Qual �o cliente que quer remover?";
//					cin>>nome;
//					try {
...
//				}/*else if(choice==3){
//							string nome;
//							cout<<" Qual �o cliente que quer alterar? ";
//							cin>> nome;
...
//				else if(choice==4){
//					string nome;
//					cout<<" Qual �o cliente que quer Procurar? ";
//					cin>> nome;
//					try {
...
//					string desig;
//					cout <<" Qual �a zona que quer remover?";
//					getline(cin,desig);
//					try {
